...
units = ('$', '%', '‰', '€', '£', '°', 'a', 'atm', 'km', 'km²', 'm', 'm²', 'm³', 'mbar', 'cm',
         'ct', 'd', 'dB', 'eks', 'h', 'ha', 'hj', 'hl', 'Hz', 'mm', 'tk', 'p', 'rbl', 'rm', 'lk',
         'pk', 's', 'sl', 'spl', 'sek', 'tk', 'tl', 'kr', 'min', 't', 'mln', 'mld', 'mg',
         'g', 'kg', 'ml', 'l', 'cl', 'dl',
         'V', 'Hz', 'W', 'kW', 'kWh', 'kHz', 'MHz', 'μg', 'mol', 'nmol')
...
pronounceable_acronyms = ('ABBA', 'AIDS', 'ALDE', 'API', 'ARK', 'ATKO',
                          ...
                          'PERH', 'PID', 'PIN', 'PRIA', 'RAF', 'RET', 'SAAB',
...
with importlib.resources.path('livekit.plugins.neurok_tts.tts_preprocess_et', 'data') as data_path:
    names_path = data_path / "names.txt"
    with open(names_path, encoding='utf8') as f:
        for line in f.readlines():
            key, val = line.strip('\n').split('\t')
            names[key.lower()] = val.lower()
'''
